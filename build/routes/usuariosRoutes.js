...
class UsuariosRoutes {
    ...
    config() {
        ...
        this.router.get("/usuarioByTipoUsuarioDiferenteAdmin/:tipo", validarToken_1.verifyToken, usuariosController_1.usuariosController.getUsuarioByDiferenteAdmin);
        ...
        this.router.get("/usuarioForget/:email", usuariosController_1.usuariosController.getUsuarioForget);
